...
End result: Bar graph that has grade on the x axis and percentage of low income houses on the y axis 

How to do this: 
- left join la_holc to la_county 
- select 'LOWINCPCT' % of census block that is low income 
